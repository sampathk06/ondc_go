...
type QuotationBreakupInner struct {
	...
	OndcOrgItemQuantity *Selected `json:"@ondc/org/item_quantity,omitempty"`
...
// GetOndcOrgItemQuantity returns the OndcOrgItemQuantity field value if set, zero value otherwise.
func (o *QuotationBreakupInner) GetOndcOrgItemQuantity() Selected {
	if o == nil || isNil(o.OndcOrgItemQuantity) {
		var ret Selected
		return ret
	}
	return *o.OndcOrgItemQuantity
}

// GetOndcOrgItemQuantityOk returns a tuple with the OndcOrgItemQuantity field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *QuotationBreakupInner) GetOndcOrgItemQuantityOk() (*Selected, bool) {
	if o == nil || isNil(o.OndcOrgItemQuantity) {
    return nil, false
	}
	return o.OndcOrgItemQuantity, true
}
...
// SetOndcOrgItemQuantity gets a reference to the given Selected and assigns it to the OndcOrgItemQuantity field.
func (o *QuotationBreakupInner) SetOndcOrgItemQuantity(v Selected) {
	o.OndcOrgItemQuantity = &v
}
...
func (o QuotationBreakupInner) MarshalJSON() ([]byte, error) {
	...
	if !isNil(o.OndcOrgItemQuantity) {
		toSerialize["@ondc/org/item_quantity"] = o.OndcOrgItemQuantity
	}
