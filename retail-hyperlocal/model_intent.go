...
// Intent Intent of a user. Used for searching for services. Buyer App can set finder fee type in payment.\"@ondc/org/buyer_app_finder_fee_type\" and amount in \"@ondc/org/buyer_app_finder_fee_amount\"
type Intent struct {
