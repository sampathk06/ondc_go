...
type Provider struct {
	...
	OndcOrgFssaiLicenseNo string `json:"@ondc/org/fssai_license_no"`
...
// GetOndcOrgFssaiLicenseNo returns the OndcOrgFssaiLicenseNo field value
func (o *Provider) GetOndcOrgFssaiLicenseNo() string {
	...
	return o.OndcOrgFssaiLicenseNo
}

// GetOndcOrgFssaiLicenseNoOk returns a tuple with the OndcOrgFssaiLicenseNo field value
// and a boolean to check if the value has been set.
func (o *Provider) GetOndcOrgFssaiLicenseNoOk() (*string, bool) {
	if o == nil {
    return nil, false
	}
	return &o.OndcOrgFssaiLicenseNo, true
}

// SetOndcOrgFssaiLicenseNo sets field value
func (o *Provider) SetOndcOrgFssaiLicenseNo(v string) {
	o.OndcOrgFssaiLicenseNo = v
}
...
func (o Provider) MarshalJSON() ([]byte, error) {
	...
	if true {
		toSerialize["@ondc/org/fssai_license_no"] = o.OndcOrgFssaiLicenseNo
	}
	if !isNil(o.Rating) {
