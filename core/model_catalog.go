...
// GetBppDescriptor returns the BppDescriptor field value if set, zero value otherwise.
func (o *Catalog) GetBppDescriptor() Descriptor {
	if o == nil || isNil(o.BppDescriptor) {
		var ret Descriptor
		return ret
	}
...
// GetBppDescriptorOk returns a tuple with the BppDescriptor field value if set, nil otherwise
...
// SetBppDescriptor gets a reference to the given Descriptor and assigns it to the BppDescriptor field.
...
// GetBppProviders returns the BppProviders field value if set, zero value otherwise.
func (o *Catalog) GetBppProviders() []Provider {
	if o == nil || isNil(o.BppProviders) {
		var ret []Provider
		return ret
	}
...
// GetBppProvidersOk returns a tuple with the BppProviders field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetBppProviders gets a reference to the given []Provider and assigns it to the BppProviders field.
