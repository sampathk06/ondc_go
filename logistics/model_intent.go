...
type Intent struct {
	...
	OndcOrgPayloadDetails *IntentOndcOrgPayloadDetails `json:"@ondc/org/payload_details,omitempty"`
...
// GetOndcOrgPayloadDetails returns the OndcOrgPayloadDetails field value if set, zero value otherwise.
func (o *Intent) GetOndcOrgPayloadDetails() IntentOndcOrgPayloadDetails {
	if o == nil || isNil(o.OndcOrgPayloadDetails) {
		var ret IntentOndcOrgPayloadDetails
		return ret
	}
	return *o.OndcOrgPayloadDetails
}

// GetOndcOrgPayloadDetailsOk returns a tuple with the OndcOrgPayloadDetails field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Intent) GetOndcOrgPayloadDetailsOk() (*IntentOndcOrgPayloadDetails, bool) {
	if o == nil || isNil(o.OndcOrgPayloadDetails) {
    return nil, false
	}
	return o.OndcOrgPayloadDetails, true
}
...
// SetOndcOrgPayloadDetails gets a reference to the given IntentOndcOrgPayloadDetails and assigns it to the OndcOrgPayloadDetails field.
func (o *Intent) SetOndcOrgPayloadDetails(v IntentOndcOrgPayloadDetails) {
	o.OndcOrgPayloadDetails = &v
}
...
func (o Intent) MarshalJSON() ([]byte, error) {
	...
	if !isNil(o.OndcOrgPayloadDetails) {
		toSerialize["@ondc/org/payload_details"] = o.OndcOrgPayloadDetails
	}
	if !isNil(o.Tags) {
