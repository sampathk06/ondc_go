...
type Order struct {
	...
	// order created by
	OndcOrgCreatedBy *string `json:"@ondc/org/created_by,omitempty"`
	OndcOrgCancellation *Cancellation `json:"@ondc/org/cancellation,omitempty"`
	OndcOrgLinkedOrder *OrderOndcOrgLinkedOrder `json:"@ondc/org/linked_order,omitempty"`
}
...
// GetOndcOrgCreatedBy returns the OndcOrgCreatedBy field value if set, zero value otherwise.
func (o *Order) GetOndcOrgCreatedBy() string {
	if o == nil || isNil(o.OndcOrgCreatedBy) {
		var ret string
		return ret
	}
	return *o.OndcOrgCreatedBy
}

// GetOndcOrgCreatedByOk returns a tuple with the OndcOrgCreatedBy field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Order) GetOndcOrgCreatedByOk() (*string, bool) {
	if o == nil || isNil(o.OndcOrgCreatedBy) {
    return nil, false
	}
	return o.OndcOrgCreatedBy, true
}
...
// SetOndcOrgCreatedBy gets a reference to the given string and assigns it to the OndcOrgCreatedBy field.
func (o *Order) SetOndcOrgCreatedBy(v string) {
	o.OndcOrgCreatedBy = &v
}
...
// GetOndcOrgLinkedOrder returns the OndcOrgLinkedOrder field value if set, zero value otherwise.
func (o *Order) GetOndcOrgLinkedOrder() OrderOndcOrgLinkedOrder {
	if o == nil || isNil(o.OndcOrgLinkedOrder) {
		var ret OrderOndcOrgLinkedOrder
		return ret
	}
	return *o.OndcOrgLinkedOrder
}

// GetOndcOrgLinkedOrderOk returns a tuple with the OndcOrgLinkedOrder field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Order) GetOndcOrgLinkedOrderOk() (*OrderOndcOrgLinkedOrder, bool) {
	if o == nil || isNil(o.OndcOrgLinkedOrder) {
    return nil, false
	}
	return o.OndcOrgLinkedOrder, true
}
...
// SetOndcOrgLinkedOrder gets a reference to the given OrderOndcOrgLinkedOrder and assigns it to the OndcOrgLinkedOrder field.
func (o *Order) SetOndcOrgLinkedOrder(v OrderOndcOrgLinkedOrder) {
	o.OndcOrgLinkedOrder = &v
}
...
func (o Order) MarshalJSON() ([]byte, error) {
	...
	if !isNil(o.OndcOrgCreatedBy) {
		toSerialize["@ondc/org/created_by"] = o.OndcOrgCreatedBy
	}
	if !isNil(o.OndcOrgCancellation) {
		toSerialize["@ondc/org/cancellation"] = o.OndcOrgCancellation
	}
	if !isNil(o.OndcOrgLinkedOrder) {
		toSerialize["@ondc/org/linked_order"] = o.OndcOrgLinkedOrder
	}
